  ...
  p: {
    ...
    group: {
      ...
      confirm: {
        delete: {
          content:
            'You will <strong>dismiss</strong> or <strong>quit</strong> team <strong>{name}</strong> , are you sure?'
        }
      },
      create: {
    ...
    login: {
      ...
      confirm: {
        register: {
          content:
            "User does't exsit, do you want create a new user with this username and password? Notice: You cannot retrieve your password if you forget in this version",
    ...
    new: {
      ...
      form: {
        ...
        swagger:
          'Swagger Docs API | Optional | If backend provides Swagger Doc (without authentication error), Easy Mock will create Mock based on Swagger API address you provide.',
        member: [
          'Ask people join for collaboration',
          'Optional | Lose effectiveness under team project',
          'Support fuzzy search, user nickname, username'
        ],
        confirm:
          'Please type in the name of the project to confirm. | Project name | This action <strong>CANNOT<strong> be undone. This will permanently delete project:',
        button: {
    ...
    project: {
      header: {
        ...
        description: [
          'Here are all your personal projects, also projects you are working with.',
          "Welcome join group {groupName}, Let's Mock up together.",
      ...
      placeholder: [
        ...
        'Wanna work faster? Add to projects to Work Station.',
        'No match founded'
      ],
      ...
      modal: {
        delete: {
          ...
          description:
            'Please type in the name of the project to confirm. | This action <strong>CANNOT<strong> be undone. This will permanently delete project:',
          button: 'Delete',
    ...
    detail: {
      ...
      remove: {
        confirm: [
          'This action <strong>CANNOT<strong> be undone. Are you sure want to delete selected row?',
          'This action <strong>CANNOT<strong> be undone. Do you want contiune?'
        ],
